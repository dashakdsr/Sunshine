...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.android.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static final String COLUMN_LOC_LON = "location_lon";
        public static final String COLUMN_LOC_SETTING = "location_settings";

        public static Uri buildLocationUri(long i) {
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherUri(long i) {
            return ContentUris.withAppendedId(CONTENT_URI, i);
        }
